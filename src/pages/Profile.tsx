...
export default function Profile() {
  ...
  const performanceData = [
    { name: 'Semana 1', mmr: 2100 },
    { name: 'Semana 2', mmr: 2150 },
    { name: 'Semana 3', mmr: 2120 },
    { name: 'Semana 4', mmr: 2280 },
    { name: 'Semana 5', mmr: 2350 },
    { name: 'Semana 6', mmr: 2310 },
    { name: 'Semana 7', mmr: 2450 },
  ];

  const recentMatches = [
    { id: 1, result: "VICTORIA", score: "12 - 4", game: "Street Fighter II", time: "hace 2h", kda: "Perfecto", impact: "Alto" },
    { id: 2, result: "DERROTA", score: "2 - 3", game: "Sonic Speedrun", time: "hace 5h", kda: "04:12.05", impact: "Bajo" },
    { id: 3, result: "VICTORIA", score: "1er Puesto", game: "Tetris Grand Prix", time: "hace 1d", kda: "450k pts", impact: "Alto" },
    { id: 4, result: "VICTORIA", score: "3 - 0", game: "Street Fighter II", time: "hace 2d", kda: "Impecable", impact: "Medio" },
  ];
        ...
        <div className="absolute bottom-0 left-0 w-full">
          <div className="max-w-7xl mx-auto px-4 md:px-8 pb-8 flex flex-col md:flex-row items-end gap-6 md:gap-8">
            ...
            <div className="relative group shrink-0">
              ...
              <div className="absolute -bottom-3 left-1/2 -translate-x-1/2 bg-emerald-600 text-white text-[10px] font-retro px-3 py-1 rounded-full border-2 border-zinc-950 z-20 whitespace-nowrap tracking-wider">
                LVL 99
              </div>
            </div>
            ...
            <div className="flex-1 pb-2 text-center md:text-left">
              <div className="flex items-center justify-center md:justify-start gap-3 mb-2">
                {isRetroPassActive && (
                  <span className="px-2 py-1 bg-emerald-500/20 text-emerald-400 text-[10px] font-retro uppercase tracking-wider border border-emerald-500/20 rounded flex items-center gap-1">
                    <Crown className="w-3 h-3" /> Retro Pass Activo
                  </span>
                )}
                {streamerMode && (
                  <span className="px-2 py-1 bg-magenta-accent/20 text-magenta-accent text-[10px] font-retro uppercase tracking-wider border border-magenta-accent/20 rounded flex items-center gap-1">
              ...
              <div className="flex items-center justify-center md:justify-start gap-3 mb-1">
                <h1 className="text-3xl md:text-5xl font-retro italic uppercase tracking-tighter text-white drop-shadow-lg">
                ...
                <div className="flex items-center gap-1 mt-2">
                  ...
                  <div className="p-1.5 bg-yellow-500/20 text-yellow-400 rounded-md border border-yellow-500/30 tooltip-trigger" title="Ganador de Torneo">
              ...
              <div className="flex items-center justify-center md:justify-start gap-3 mb-4">
                <button 
                  ...
                  className="flex items-center gap-2 px-4 py-2 bg-emerald-500 hover:bg-emerald-600 text-black font-retro uppercase tracking-widest rounded-lg transition-colors text-sm"
                >
                ...
                <button 
                  ...
                  className="flex items-center gap-2 px-4 py-2 bg-white/10 hover:bg-white/20 text-white font-retro uppercase tracking-widest rounded-lg transition-colors text-sm"
                >
              ...
              <div className="max-w-md mx-auto md:mx-0">
                <div className="flex justify-between items-end mb-1">
                  <span className="text-[10px] text-zinc-400 font-retro uppercase tracking-wider">Progreso Nivel 100</span>
            ...
            <div className="hidden md:flex flex-col items-end pb-2">
              <p className="text-xs text-zinc-500 font-retro uppercase tracking-wider mb-2">Rango Actual</p>
              <div className="flex items-center gap-4 bg-zinc-900/80 backdrop-blur-md border border-white/10 px-6 py-3 rounded-2xl shadow-xl">
                ...
                <div>
                  <div className="text-2xl font-retro italic uppercase tracking-tighter text-white">{userRank?.rank_name || 'RECLUTA'}</div>
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 pt-6 md:pt-8 space-y-6 md:space-y-8">
        ...
        <div className="flex flex-col lg:grid lg:grid-cols-3 gap-6 md:gap-8">
            ...
            {[
              ...
              >
                <div className="flex items-center gap-2 text-zinc-500 mb-2 md:mb-3">
                  ...
                  <span className="text-[9px] md:text-xs font-retro uppercase tracking-wider">{stat.label}</span>
                </div>
          ...
          >
            ...
            <div className="flex justify-between items-center mb-4 md:mb-6 relative z-10">
              <h3 className="text-white font-retro italic uppercase tracking-tighter flex items-center gap-2 text-sm md:text-base">
                <Activity className="w-4 h-4 md:w-5 md:h-5 text-emerald-500" />
                Progresión MMR
              </h3>
              <select className="bg-black/50 border border-white/10 rounded-lg px-2 py-1 text-[10px] text-zinc-400 font-retro uppercase tracking-widest outline-none focus:border-emerald-500 transition-colors">
        ...
        >
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
            <div className="flex-1">
              <div className="inline-flex items-center gap-2 px-2.5 py-1 rounded-full bg-emerald-500/20 border border-emerald-500/30 text-emerald-400 text-[10px] md:text-xs font-retro uppercase tracking-wider mb-3">
                <Zap className="w-3 h-3 md:w-4 md:h-4" /> Programa de Embajadores
              </div>
              <h3 className="text-2xl md:text-3xl font-retro italic uppercase tracking-tighter text-white mb-2">Invita y Gana Packs Premium</h3>
              <p className="text-zinc-300 text-sm md:text-base mb-6 max-w-xl">
                Por cada 3 amigos que se registren con tu enlace y jueguen su primera partida, desbloqueas un <strong className="font-retro text-emerald-400">Premium Game Pack</strong> gratis.
              </p>
              ...
              <div className="flex flex-col sm:flex-row items-center gap-3 w-full max-w-md">
                <div className="relative w-full">
                  ...
                  <button 
                    ...
                    className="absolute right-2 top-1/2 -translate-y-1/2 px-4 py-1.5 bg-emerald-600 hover:bg-emerald-500 text-white rounded-lg text-xs font-retro uppercase tracking-wider transition-colors"
                  >
                    Copiar
                  </button>
                </div>
            ...
            <div className="w-full md:w-64 bg-black/40 border border-white/10 rounded-xl p-5 shrink-0 flex flex-col justify-center">
              <div className="flex justify-between items-end mb-2">
                <span className="text-zinc-400 text-xs font-retro uppercase tracking-wider">Progreso</span>
                <span className="text-emerald-400 font-mono font-retro text-lg">{referralData.invites % 3}/3</span>
              </div>
        ...
        >
          <div className="flex items-center justify-between mb-6">
            <h3 className="text-xl font-retro italic uppercase tracking-tighter flex items-center gap-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="space-y-3">
              <h4 className="text-[10px] font-retro text-zinc-500 uppercase tracking-widest flex items-center gap-2">
                  ...
                  <div key={item.id} className="flex items-center gap-3 p-3 bg-black/40 border border-white/5 rounded-xl">
                    ...
                    <div className="flex-1">
                      ...
                      {equipped.feature === item.id && (
                        <span className="text-[8px] font-retro text-emerald-400 uppercase tracking-tighter">Activo</span>
                      )}
                    </div>
                  </div>
                ))}
          ...
          <div className="space-y-6 md:space-y-8">
              ...
              <div className="flex flex-col gap-4">
                <div className="bg-black/40 border border-white/5 rounded-xl p-4 flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-xs text-zinc-500 font-retro uppercase tracking-wider">Total Ganado</p>
                      <p className="text-xl font-mono font-retro text-white">125,000 CR</p>
                    </div>
                  </div>
                </div>
                <div className="bg-black/40 border border-white/5 rounded-xl p-4 flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-xs text-zinc-500 font-retro uppercase tracking-wider">Torneos Jugados</p>
                      <p className="text-xl font-mono font-retro text-white">42</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            >
              <div className="flex justify-between items-center mb-4 md:mb-6">
                ...
                <button className="text-[10px] md:text-xs text-zinc-500 font-retro uppercase tracking-widest hover:text-white transition-colors">Ver Todo</button>
              </div>
              ...
              <div className="grid grid-cols-2 gap-3 md:gap-4">
                {trophies.map((trophy) => (
                  ...
                  >
                    ...
                    <div>
                      <p className={`text-[10px] md:text-xs font-retro uppercase tracking-tighter leading-tight ${trophy.isUnlocked ? 'text-white' : 'text-zinc-600'}`}>{trophy.name}</p>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <motion.section 
              ...
              className="bg-zinc-900/50 backdrop-blur-md border border-white/5 rounded-2xl p-5 md:p-6"
            >
              <h3 className="text-emerald-400 font-retro italic uppercase tracking-tighter mb-4 md:mb-6 flex items-center gap-2 text-sm md:text-base">
                ...
                {coachInsights.length > 0 ? coachInsights.map((insight) => (
                  <div key={insight.id} className="p-3 md:p-4 bg-black/40 rounded-xl border border-white/5 hover:border-emerald-500/30 transition-colors group">
                    <div className="flex justify-between items-start mb-2">
                      <span className="text-[8px] md:text-[10px] font-retro px-1.5 md:px-2 py-0.5 md:py-1 rounded uppercase tracking-wider bg-emerald-500/10 text-emerald-400 border border-emerald-500/20">
            ...
            >
              <div className="flex justify-between items-center mb-4 md:mb-6">
                ...
                <button className="text-[10px] md:text-xs text-zinc-500 font-retro uppercase tracking-widest hover:text-white transition-colors">Ver Todos</button>
              </div>
              ...
              <div className="space-y-4">
                {friends.length > 0 ? friends.map(friend => (
                  <div key={friend.user_id} className="flex items-start gap-3 group cursor-pointer">
                    ...
                    <div className="flex-1">
                      <p className="text-xs text-white font-retro uppercase tracking-widest group-hover:text-blue-400 transition-colors">
                        {friend.username}
                      </p>
                      <span className="text-[10px] text-zinc-500 font-retro uppercase tracking-widest">
          ...
          >
            <section className="bg-zinc-900/50 backdrop-blur-md border border-white/5 rounded-2xl p-5 md:p-6 h-full flex flex-col">
              <div className="flex justify-between items-center mb-4 md:mb-6">
                ...
                <button className="text-[10px] md:text-xs text-emerald-400 hover:text-emerald-300 font-retro uppercase tracking-widest flex items-center gap-1">
              ...
              <div className="flex-1 space-y-2">
                ...
                <div className="hidden md:grid grid-cols-12 gap-4 px-4 py-3 text-[10px] font-retro text-zinc-500 uppercase tracking-widest border-b border-white/5 mb-2">
                ...
                {recentMatches.map((match) => (
                  <div key={match.id} className="flex flex-col md:grid md:grid-cols-12 gap-2 md:gap-4 px-3 md:px-4 py-3 md:py-4 bg-black/20 hover:bg-white/5 border border-transparent hover:border-white/5 rounded-xl transition-all cursor-pointer group">
                    ...
                    <div className="flex md:hidden justify-between items-center mb-1">
                      <span className={`text-[10px] font-retro uppercase tracking-widest px-1.5 py-0.5 rounded ${match.result === 'VICTORY' ? 'bg-emerald-500/10 text-emerald-400' : 'bg-red-500/10 text-red-400'}`}>
                    ...
                    <div className="hidden md:block col-span-2">
                      <span className={`text-xs font-retro uppercase tracking-widest px-2 py-1 rounded ${match.result === 'VICTORY' ? 'bg-emerald-500/10 text-emerald-400' : 'bg-red-500/10 text-red-400'}`}>
                        {match.result === 'VICTORY' ? 'VICTORIA' : 'DERROTA'}
                      </span>
                    </div>

                    {/* Game Info */}
                    <div className="col-span-4 font-retro uppercase tracking-widest text-white text-xs md:text-sm truncate group-hover:text-emerald-400 transition-colors">
                      {match.game}
                    </div>
                    ...
                    <div className="flex md:contents justify-between items-center mt-1 md:mt-0">
                      ...
                      <div className="col-span-2">
                        <span className={`text-[9px] md:text-[10px] font-retro uppercase tracking-wider ${match.impact === 'High' ? 'text-emerald-400' : match.impact === 'Medium' ? 'text-yellow-400' : 'text-zinc-500'}`}>
            ...
            <section className="bg-zinc-900/50 backdrop-blur-md border border-white/5 rounded-2xl p-5 md:p-6 mt-6 md:mt-8">
              ...
              <div className="space-y-2">
                {topPlayers.map((player, index) => (
                  ...
                  >
                    <div className="w-8 h-8 flex items-center justify-center font-mono font-retro text-zinc-500">
                      {index === 0 ? '🥇' : index === 1 ? '🥈' : index === 2 ? '🥉' : `#${index + 1}`}
                    </div>
                    <div className="flex-1">
                      <div className="flex items-center gap-2">
                        <span className="font-retro uppercase tracking-widest text-white">{player.username}</span>
                        {player.user_id === user?.id && (
                          <span className="text-[8px] font-retro bg-emerald-500 text-black px-1.5 py-0.5 rounded uppercase">Tú</span>
                        )}
                      </div>
                      <span className="text-[10px] text-zinc-500 font-mono uppercase">{player.rank_name}</span>
                    </div>
                    <div className="text-right">
                      <div className="text-sm font-retro text-emerald-400">{player.score}</div>
                      <div className="text-[8px] text-zinc-500 font-retro uppercase tracking-widest">MMR</div>
                    </div>
                  </div>
                ))}
                {topPlayers.length === 0 && (
            ...
            <section className="bg-zinc-900/50 backdrop-blur-md border border-white/5 rounded-2xl p-5 md:p-6 mt-6 md:mt-8">
              <div className="flex justify-between items-center mb-4 md:mb-6">
                ...
                <button className="text-[10px] md:text-xs text-zinc-500 font-retro uppercase tracking-widest hover:text-white transition-colors">Editar</button>
              </div>
                ...
                {[
                  ...
                  <div key={game.id} className="relative aspect-[3/4] rounded-xl overflow-hidden border border-white/10 group cursor-pointer">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity flex items-end p-3">
                      <span className="text-white text-[10px] font-retro uppercase tracking-tighter leading-tight">{game.title}</span>
                    </div>
                  </div>
                ))}
              </div>
                ...
                {[
                  ...
                  <div key={clip.id} className="group relative rounded-xl overflow-hidden border border-white/10 cursor-pointer">
                    ...
                    <div className="p-3 bg-zinc-950/80">
                      <h4 className="text-xs font-retro uppercase tracking-widest text-white truncate">{clip.title}</h4>
                      <div className="flex justify-between items-center mt-1 mb-2">
                        <span className="text-[10px] text-zinc-400">{clip.game}</span>
                        <span className="text-[10px] font-retro uppercase tracking-widest text-purple-400">{clip.views} vistas</span>
                      </div>
                      <button 
                        onClick={(e) => { e.stopPropagation(); alert('Compartiendo en TikTok...'); }}
                        className="w-full py-1.5 bg-white text-black text-[10px] font-retro uppercase tracking-widest rounded hover:bg-zinc-200 transition-colors"
                      >
                        Compartir en TikTok
                      </button>
                    </div>
