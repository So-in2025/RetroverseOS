...
const COMPACT_CATALOG: CompactGame[] = [
  ...
  ['Pokemon Emerald', GBA, 2005, 'Nintendo', 'Game Freak', 1, 'Pokemon - Emerald Version (USA, Europe)'],
  ['Pokemon FireRed', GBA, 2004, 'Nintendo', 'Game Freak', 1, 'Pokemon - FireRed Version (USA, Europe)'],
  ['Pokemon LeafGreen', GBA, 2004, 'Nintendo', 'Game Freak', 1, 'Pokemon - LeafGreen Version (USA, Europe)'],
  ...
  ['Super Mario Advance 2: Super Mario World', GBA, 2002, 'Nintendo', 'Nintendo', 1, 'Super Mario Advance 2 - Super Mario World (USA, Australia)'],
