...
class ProfileSyncService {
  ...
  async pullProfile(userId: string) {
    ...
    try {
      ...
      // Re-initialize services to reflect new data
      // This is a bit tricky since we don't want circular dependencies
      // We'll rely on the app re-rendering or manual refresh for now, 
      // or better, trigger a reload of the page if major data changed.
